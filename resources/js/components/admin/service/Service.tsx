...
const Service: FC<IProps> = (props: IProps) => {
    ...
    return <div className="row">
        {showAddSpecialist && <Popup onPopupClose={() => {setShowAddSpecialist(undefined)}} isSmall={true} parentId={"2437n"} children={<SpecialistAdd default={showAddSpecialist}/>}/>}
        ...
        <div className="col-12">
            <div className="card">
                <div className="card-header">
                    ...
                    <button onClick={() => setShowAdd(true)} className="btn btn-outline-primary btn-md ms-auto">Ajouter service</button>
                </div>
                <div className="table-responsive">
                    <table className="table card-table table-striped table-vcenter" role="grid">
                        <thead>
                        <tr role="row">
                        ...
                        {state.map((rep: any, key: any) => {
                            return <tr key={key} role="row">
                                ...
                                <td className=""><span className="text-muted">
                                ...
                                <td className="text-right">
                                    <div className="item-action dropdown">
                                        ...
                                        <div className="dropdown-menu dropdown-menu-right" x-placement="bottom-center"
                                            ...
                                            <button className="dropdown-item" onClick={() => setShowAddSpecialist({service: rep})}>
